...
class Facebook extends Service
{
  public function _facebook()
  {
    ...
    $limit=100;
    $sort=['di'=>-1,'ds'=>-1];
    $start_time = Load::Time()->from('2017-08-25 08:00:00');

    if($tmp=$this->find($arg,['d'=>1],['sort'=>$sort,'skip'=>$skip,'limit'=>$limit]))
    {
      foreach($tmp as $v)
      {
        $link=$v['link'];
        ...
        $data[]=[
          'guid'=>$v['sv'].'.'.$v['_id'],
          'stats'=>'https://'.$v['sv'].'/stats/'.$v['_id'].'/'.$v['u'],
          'page'=>'fb:'.$v['sv'],
          'title'=>$v['t'],
          'content'=>$ct,
          'author'=>$v['un']?:DOMAIN,
          ...
          'image'=>'https://'.$v['sv'].'/files/'.$v['fd'].'/original.jpg',
          'link'=>$link,
  ...
  <channel>
  <title>'.Load::$core->data['title'].'</title>
  <description><![CDATA['.Load::$core->data['description'].']]></description>
  ...
  <meta property="fb:app_id" content="'.Load::$core->data['fb']['appid'].'">
  ...
  <header>
    ...
    <figure class="op-ad"><iframe width="300" height="250" style="border:0; margin:0;" src="https://www.facebook.com/adnw_request?placement='.Load::$core->data['fb']['audience'][0].'&adtype=banner300x250"></iframe></figure>
    <figure class="op-ad"><iframe width="300" height="250" style="border:0; margin:0;" src="https://www.facebook.com/adnw_request?placement='.Load::$core->data['fb']['audience'][1].'&adtype=banner300x250"></iframe></figure>
    <figure class="op-ad"><iframe width="300" height="250" style="border:0; margin:0;" src="https://www.facebook.com/adnw_request?placement='.Load::$core->data['fb']['audience'][2].'&adtype=banner300x250"></iframe></figure>
    <figure class="op-ad op-ad-default"><iframe width="300" height="250" style="border:0; margin:0;" src="https://www.facebook.com/adnw_request?placement='.Load::$core->data['fb']['audience'][3].'&adtype=banner300x250"></iframe></figure>
    </section>
  </header>
  '.$data[$i]['content'].'
  <footer>
  ...
  ga("create", "UA-31362918-1", "'.DOMAIN.'");
  ...
  public function call_facebook($txt)
  {
    ...
    if(substr($link,0,4)=='http')
    {
      ...
      js.src = "//connect.facebook.net/th_TH/sdk.js#xfbml=1&version=v2.10&appId='.Load::$core->data['fb']['appid'].'";
